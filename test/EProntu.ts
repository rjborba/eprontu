...
import { EProntu__factory } from "../typechain-types";
...
describe("EProntu", function () {
  ...
  describe("Deployment", function () {
    ...
    it("Dummy call", async function () {
      const provider = await ethers.provider;

      const eProntu = EProntu__factory.connect(
        "0xa0Feb6BD955e42c1b8055161B60DA9b0669Ee35a",
        provider
      );

      const addresses = await eProntu.getAuthorizedAddresses();
